...
with st.sidebar:
        ...
        db_channel=master_conn.query("select distinct channel from master;")
        ...
        db_article_type=master_conn.query("select distinct article_type,brand from master")
    ...
    for i in range(tab_len):
        with tab_suggestion[i]:
                ...
                if st.button("Accept Actions ✅"):
                        ...
                        db_action_items_manual=master_conn.read(worksheet="action_items_manual",ttl=2)
                        ...
                        master_conn.update(worksheet="action_items_manual",data=db_action_items_manual_1) 
